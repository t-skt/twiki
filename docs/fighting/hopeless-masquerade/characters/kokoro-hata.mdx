...
sidebar_position: 1
title: "하타노 코코로"
description: "동방심기루의 캐릭터"
displayed_sidebar: th135Sidebar
---

import { CharacterProfile } from '@site/src/components';
import hatanoKokoro from '@site/static/img/th135/hatano_kokoro.webp';

:::info
데이터 출처: [Touhou Patch Center — Th135/Omake](https://www.thpatch.net/wiki/Th135/omake.txt/ko).\
