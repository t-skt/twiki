...
import himemushiMomoyo from '@site/static/img/th18/himemushi_momoyo.webp';
...
## 히메무시 모모요 (Himemushi Momoyo)

<CharacterProfile
  name="히메무시 모모요"
  nameJa="姫虫百々世"
  nameEn="Himemushi Momoyo"
  ability="용을 먹는 정도의 능력"
  title="검은 드래곤 이터"
  species="오오무카데 (거대 지네)"
  themeColor="#607D8B"
  image={himemushiMomoyo}
>
  오오무카데.\
