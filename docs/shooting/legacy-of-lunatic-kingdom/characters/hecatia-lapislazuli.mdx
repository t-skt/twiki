...
import hecatiaLapislazuli from '@site/static/img/th15/hecatia_lapislazuli.webp';
...
## 헤카티아 라피스라줄리 (Hecatia Lapislazuli)

<CharacterProfile
  name="헤카티아 라피스라줄리"
  nameJa="ヘカーティア・ラピスラズリ"
  nameEn="Hecatia Lapislazuli"
  ability="세 개의 신체를 가지는 정도의 능력"
  title="지옥의 여신"
  species="신"
  themeColor="#311B92"
  image={hecatiaLapislazuli}
>
