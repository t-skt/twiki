...
<div class="fusion-toc">
  <div class="fusion-toc__cards">
    <a class="fusion-toc__card" href="/twiki/docs/side/impossible-spell-card/dialogue/overview"><span class="fusion-toc__card-icon">📖</span><span class="fusion-toc__card-title">스토리</span><span class="fusion-toc__card-desc">시나리오 · 대사</span></a>
    <a class="fusion-toc__card" href="/twiki/docs/side/impossible-spell-card/spell-cards"><span class="fusion-toc__card-icon">🎴</span><span class="fusion-toc__card-title">스펠카드</span><span class="fusion-toc__card-desc">보스별 스펠 목록</span></a>
    <a class="fusion-toc__card" href="/twiki/docs/side/impossible-spell-card/music"><span class="fusion-toc__card-icon">🎵</span><span class="fusion-toc__card-title">OST</span><span class="fusion-toc__card-desc">사운드트랙</span></a>
  ...
  <div class="fusion-toc__section" id="gm-story">
    ...
    <div class="fusion-toc__scenario-grid">
      <a class="fusion-toc__scenario-card" href="/twiki/docs/side/impossible-spell-card/characters/seija-kijin"><strong>키진 세이자</strong><span>프로필 →</span></a>
    </div>
  </div>
  <div class="fusion-toc__section" id="gm-chars">
    <h3>캐릭터</h3>
    <div class="fusion-toc__char-grid">
      <div class="fusion-toc__char-card"><h4>키진 세이자</h4><div class="fusion-toc__char-links"><a href="/twiki/docs/side/impossible-spell-card/characters/seija-kijin">게임 내 프로필</a><a class="fusion-toc__primary" href="/twiki/docs/characters/seija-kijin">캐릭터 마스터 →</a></div></div>
    </div>
  </div>
</div>
{/* fusion-toc:end */}
